...
| `ONR_MODEL` | [Логическая модель данных](src/ONR_MODEL.png)                                                            | Представление сущностей, их атрибутов и взаимосвязей в виде ER-диаграммы                          |
...
[`ONR_MODEL.png`](src/ONR_MODEL.png) представляет логическую модель данных системы онлайн-записи в виде ER-диаграммы.
...
![Логическая модель данных](src/ONR_MODEL.png)
